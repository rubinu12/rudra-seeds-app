...
import { getFarmerPaymentDetails } from '@/lib/payment-data'; // Use the updated function
  ...
  if (!billData) {
     return (
        <div className="p-8 max-w-2xl mx-auto text-center">
            ...
            <h1 className="text-2xl font-semibold mb-4 text-error">Bill Data Not Found</h1>
            <p className="text-on-surface-variant">
                Could not retrieve details needed for the bill for Cycle ID <span className='font-bold'>{cycleId}</span>.
