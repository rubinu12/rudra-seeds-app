  ...
  return (
    <div className="w-[210mm] h-[296mm] mx-auto bg-white p-[10mm] text-[13px] leading-[1.4] box-border relative flex flex-col overflow-hidden text-black">
        <div className="border-2 border-black w-full flex flex-col h-fit">
          <div className="text-center font-bold text-[18px] border-b-2 border-black py-1.5 tracking-widest uppercase bg-gray-100 print:bg-transparent">
            INVOICE
          </div>
          <div className="flex border-b-2 border-black">
            ...
            <div className="w-1/2 flex flex-col">
              ...
              <div className="p-2 flex-grow">
                ...
                <p className="text-[12px] mt-0.5"><span className="font-bold">Terms of Delivery:</span> {deliveryTerms}</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex border-b-2 border-black min-h-[32mm]">
            <div className="w-1/2 border-r-2 border-black p-2 flex flex-col">
              ...
              <p className="whitespace-pre-wrap leading-tight">{shipment.dest_address}</p>
            ...
            <div className="w-1/2 flex flex-col">
              ...
              <div className="p-2">
                ...
                <div className="flex justify-between items-end mt-1">
                    ...
                    <p className="text-[12px] bg-gray-100 px-2 py-0.5 border border-gray-300 print:border-none print:bg-transparent font-bold">
          ...
          <div className="flex min-h-[38mm]">
            <div className="w-1/2 border-r-2 border-black p-2 flex flex-col justify-between text-[11px] leading-tight">
              ...
              <div className="mt-4 flex flex-col items-center w-[60%]">
                  <span className="font-bold text-[14px] mb-6">Receiver's Signature</span>
            ...
            <div className="w-1/2 flex flex-col">
              <div className="border-b-2 border-black p-2 flex-grow">
                <p className="font-bold underline text-[12px] mb-1">Company's Bank Details</p>
                <div className="grid grid-cols-[100px_1fr] gap-x-2 text-[12px] leading-relaxed">
              ...
              <div className="p-2 flex flex-col justify-between items-end min-h-[18mm]">
        ...
        <div className="border-2 border-black w-full flex flex-col h-fit">
          ...
          <div className="border-b-2 border-black">
              <div className="grid grid-cols-[180px_1fr]">
                  ...
                  <div className="border-b border-black p-1.5 pl-3 font-bold text-[14px]">{invoiceNo}</div>

                  <div className="border-b border-r border-black p-1.5 font-bold bg-gray-50 print:bg-transparent pl-3 text-[13px]">Date</div>
                  <div className="border-b border-black p-1.5 pl-3 font-bold text-[14px]">{shipment.dispatch_date ? new Date(shipment.dispatch_date).toLocaleDateString('en-GB') : new Date().toLocaleDateString('en-GB')}</div>
                  
                  <div className="border-b border-r border-black p-1.5 font-bold bg-gray-50 print:bg-transparent pl-3 text-[13px]">Dispatch From</div>
                  <div className="border-b border-black p-1.5 pl-3 text-[14px]">{dispatchFrom}</div>
                  
                  <div className="border-b border-r border-black p-1.5 font-bold bg-gray-50 print:bg-transparent pl-3 text-[13px]">Organizer</div>
                  <div className="border-b border-black p-1.5 pl-3 font-bold uppercase text-[14px]">Rudra Seeds & Organiser</div>
                  
                  <div className="border-b border-r border-black p-1.5 font-bold bg-gray-50 print:bg-transparent pl-3 text-[13px]">Transport Name</div>
                  <div className="border-b border-black p-1.5 pl-3 uppercase font-bold text-[14px]">{shipment.transport_name}</div>
                  
                  <div className="border-b border-r border-black p-1.5 font-bold bg-gray-50 print:bg-transparent pl-3 text-[13px]">Mode of Dispatch</div>
                  <div className="border-b border-black p-1.5 pl-3 text-[14px]">Truck No.: {shipment.vehicle_number}</div>
                  
                  <div className="border-b border-r border-black p-1.5 font-bold bg-gray-50 print:bg-transparent pl-3 text-[13px]">Destination</div>
                  <div className="border-b border-black p-1.5 pl-3 text-[14px]">{destinationCity}</div>
                  
                  <div className="border-r border-black p-1.5 font-bold bg-gray-50 print:bg-transparent pl-3 text-[13px]">No of Bags/Boxes</div>
                  <div className="p-1.5 pl-3 font-bold text-[14px]">{totalBags} Nos.</div>
              </div>
          </div>
          ...
          <div className="flex min-h-[38mm]">
            ...
            <div className="w-1/2 flex flex-col">
              <div className="p-2 flex flex-col justify-between items-end flex-grow">
                 <p className="font-bold text-[13px]">for Rudra Seeds & Organiser</p>
                 <p className="font-bold text-[13px] mt-auto">Authorised Signatory</p>
              </div>
            </div>
