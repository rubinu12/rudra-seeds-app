  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-3 gap-4">
        <div className="btn p-4 col-span-1 rounded-2xl shadow-m3-subtle text-white bg-gradient-to-br from-purple-500 to-indigo-600">
          <h4 className="text-sm font-medium opacity-80">Stock</h4>
          <p className="text-3xl mt-2">View</p>
        </div>
        <div className="btn p-4 col-span-1 rounded-2xl shadow-m3-subtle text-white bg-gradient-to-br from-sky-500 to-blue-600">
          <h4 className="text-sm font-medium opacity-80">Farmers Registered</h4>
          <p className="text-3xl mt-2">850</p>
        </div>
        <div className="btn p-4 col-span-1 rounded-2xl shadow-m3-subtle text-white bg-gradient-to-br from-amber-500 to-orange-600">
        ...
        <div className="btn p-4 col-span-2 rounded-2xl shadow-m3-subtle text-white bg-gradient-to-br from-teal-500 to-cyan-600">
        ...
        <div className="btn p-4 col-span-1 rounded-2xl shadow-m3-subtle text-white bg-gradient-to-br from-rose-500 to-pink-600">
