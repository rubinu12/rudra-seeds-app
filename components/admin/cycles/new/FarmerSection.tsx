...
export const FarmerSection = ({
    farmerState, farmState, newBankAccounts, setNewBankAccounts, searchResults, isLoading,
    existingFarms, existingAccounts, handleSelectFarmer, handleClear,
    isSearchEnabled, setIsSearchEnabled, villageOptions, addBankAccount,
    selectedFarmId, setSelectedFarmId, selectedAccountIds, setSelectedAccountIds,
    showNewFarmForm, handleToggleNewFarmForm, showNewBankAccountForm, handleToggleNewAccountForm
}: Props) => {
        ...
        <div className="flex flex-col gap-6">
            ...
            <div className="bg-surface-container rounded-[1.75rem] p-6 shadow-md">
                <div className="flex items-center justify-between gap-4 mb-6">
                    <div className="flex items-center gap-4">
                        ...
                        <h2 className="text-[1.75rem] font-normal text-on-surface">Farmer Details</h2>
                    </div>
            ...
            <div className="bg-surface-container rounded-[1.75rem] p-6 shadow-md">
                 <div className="flex items-center justify-between gap-4 mb-6">
                    ...
                    {isExistingFarmer && (
                        <button type="button" onClick={handleToggleNewFarmForm} className="inline-flex items-center justify-center px-4 py-2 text-sm border border-outline text-primary font-medium rounded-full hover:bg-primary/10 transition-colors">
            ...
            <div className="bg-surface-container rounded-[1.75rem] p-6 shadow-md">
                <div className="flex items-center justify-between gap-4 mb-6">
                    <div className="flex items-center gap-4">
                        <div className="w-12 h-12 grid place-items-center rounded-2xl bg-primary-container">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="none" stroke="#21005D" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline></svg>
                        </div>
                        <h2 className="text-[1.75rem] font-normal text-on-surface">Bank Details</h2>
                    </div>
                    {isExistingFarmer && (
                        <button type="button" onClick={handleToggleNewAccountForm} className="inline-flex items-center justify-center px-4 py-2 text-sm border border-outline text-primary font-medium rounded-full hover:bg-primary/10 transition-colors">
                            <PlusCircle className="w-4 h-4 mr-2" />
                ...
                {isExistingFarmer && (
                     <div className="space-y-2 border-b border-outline/30 pb-6 mb-6">
                        ...
                        {accountOptions.length > 0 ? accountOptions.map(option => (
                            <label key={option.value} className="flex items-center p-3 rounded-lg hover:bg-primary/10 cursor-pointer">
                                <input
                                    type="checkbox"
                                    className="sr-only peer"
